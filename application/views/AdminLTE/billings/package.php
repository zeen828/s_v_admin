                    <div class="row">
                        <div class="callout callout-info">
                            <h4>提示</h4>
                            <p><a href="http://54.199.206.243/api/configs/slide.json" target="_blank">http://54.199.206.243/api/configs/slide.json</a></p>
...
?>
                    ...
                    $(document).ready(function(){
                        $('.cancel_cache').off('click').on('click', function() {
                            if (confirm('清除cache？')) {
                                $.ajax({
                                    url: 'http://plugin-background.vidol.tv/api/configs/cancel_slide.json',
                                    type: 'GET',
                                    cache: false,
                                    headers: {
