                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="daterange" value="<?php echo date('Y-m-d', strtotime(date('Y-m-d H:i:s') . " -8 day")), ' - ', date('Y-m-d', strtotime(date('Y-m-d H:i:s') . " -1 day"));?>" class="form-control pull-right" id="reservation" placeholder="請選擇日期...">
                                    <input type="hidden" name="start" value="<?php echo date('Ymdh0000', strtotime(date('Y-m-d H:i:s') . " -8 day"));?>">
