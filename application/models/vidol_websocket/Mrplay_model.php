...
if (! defined ( 'BASEPATH' ))
	...
	class Mrplay_model extends CI_Model {
		private $table_name = 'mrplay_tbl';
		private $fields_pk = 'pk';
		...
		public function insert_Mrplay_for_data($data) {
			$this->w_db->insert ( $this->table_name, $data );
			$id = $this->w_db->insert_id ();
			// echo $this->w_db->last_query();
			return $id;
		}
		public function update_Mrplay_for_data($pk, $data) {
		...
		public function get_row_Mrplay_by_pk($select, $pk) {
			if (! empty ( $select )) {
