...
class Lotters_config_model extends CI_Model {
	private $table_name = 'lotters_config_tbl';
	private $fields_pk = 'lc_pk';
	...
	public function insert_lotters_config_for_data($data) {
		$this->w_db->insert ( $this->table_name, $data );
		$id = $this->w_db->insert_id ();
		// echo $this->w_db->last_query();
		return $id;
	}
	public function update_lotters_config_for_data($pk, $data) {
	...
	public function get_row_lotters_config_by_pk($select, $pk) {
		if (! empty ( $select )) {
