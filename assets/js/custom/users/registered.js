				...
				200: function(json, statusText, xhr) {
					if(lib = 'new'){
						Morris_line = new Morris.Line({
							...
							lineColors: ['#FF5511', '#0000FF', '#FF0088', '#000000'],
							units: '人',
							smooth: false,
							hoverCallback: function (index, options, content, row) {
								...
								"<div><span class='fa fa-vimeo' style='color: #FF5511;'>[一般註冊]&nbsp;" +  formatNumber(row.count_re) + " 人</span></div>" +
								...
								"<div><span class='fa fa-line-chart' style='color: #000000;'>[所有註冊]&nbsp;" +  formatNumber(row.count) + " 人</span></div>" +
								"</div>";
							}
						});
					}else{
